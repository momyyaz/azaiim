...
class WebController extends Controller
{
    ...
    {
         $product_category = $request->has('id') ? Category::findOrFail($request->id) : Category::first();
        ...
        // return view('web-views.products.view', compact('products', 'data'), $data);
          return view('web-views.products.view', compact('products', 'data', 'product_category'), $data);
    }
