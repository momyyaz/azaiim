...
class OrderController extends Controller
{
    ...
    //      // Update the delivery_time within the JSON column
    //     $shippingAddressData = json_decode($order->shipping_address_data , true);
    //     $shippingAddressData['delivery_time'] = $validatedData['delivery_time'];
        
    //     // Save the updated JSON data
    //     $order->shipping_address_data = json_encode($shippingAddressData);

    //     // Return a response
    //     return response()->json(['message' => 'Delivery time updated successfully']);
    // }
