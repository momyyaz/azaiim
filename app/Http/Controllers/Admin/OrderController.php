...
class OrderController extends Controller
{
    ...
    public function details($id)
    {
        ...
        $order_time = $shipping_address->delivery_time ;
        if($order->order_type == 'default_type')
        {
            return view('admin-views.order.order-details', compact('order_time','shipping_address','order', 'linked_orders', 'delivery_men', 'total_delivered', 'company_name', 'company_web_logo', 'physical_product'));
        }else{
            return view('admin-views.pos.order.order-details', compact('order_time','order', 'company_name', 'company_web_logo'));
        }
