                                ...
                                <div class="col-sm-12">
                                 ...
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="invalid-feedback">{{\App\CPU\translate('Please enter your Country Code')}}!</div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="reg-phone">{{\App\CPU\translate('كود الدوله')}}
                                            <small class="text-primary">( * {{\App\CPU\translate('country_code_is_must')}} {{\App\CPU\translate('like_for +20')}} )</small>
                                        </label>
                                           <input class="form-control"  type="text"  name="countryCode" placeholder="كود الدوله مطلوب ex:+20">
