            ...
            <div class="col-md-6">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <form
                            action="{{route('admin.business-settings.payment-method.update',['myfatoorah'])}}"
                            method="post">
                            @csrf
                            @if(isset($config))
                                @php($config['environment'] = $config['environment']??'sandbox')
                                <div class="d-flex flex-wrap gap-2 justify-content-between mb-3">
                                    <h5 class="text-uppercase">Myfatoorah</h5>
                                ...
                                <center class="mb-3">
                                    <img height="60" src="https://www.myfatoorah.com/assets/img/logo.png" alt="">
                                </center>

                                <div class="form-group">
                                    <label class="d-flex title-color">
                                        {{\App\CPU\translate('Test_Mode')}}
                                    </label>
                                    <select class="js-example-responsive form-control" name="test_mode">
                                        <option value="true" {{$config['test_mode']=='true'?'selected':''}}>
                                            True
                                        </option>
                                        <option value="false" {{$config['test_mode']=='false'?'selected':''}}>
                                            False
                                        </option>
                                    </select>
                                </div>
