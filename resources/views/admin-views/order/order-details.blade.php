                        ...
                        <div class="d-flex flex-wrap gap-10 justify-content-between mb-4">
                            ...
                            <div class="text-sm-right">
                                ...
                                <div class="d-flex flex-column gap-2 mt-3">
                                  ...
                                  <div>
                                        @if(json_decode($order->shipping_address_data)->delivery_time != null || $order->delivery_time != null)
                                            @php
                                            if($order->delivery_time != null) {
                                                $delivery_time = \Carbon\Carbon::make($order->delivery_time)->toDayDateTimeString();
                                            } else {
                                                $delivery_time = \Carbon\Carbon::make(json_decode($order->shipping_address_data)->delivery_time)->toDayDateTimeString();
                                                
                                            }
                                            @endphp
                                            <span style="font-size: 20px;">وقت التوصيل :</span>
                                            <strong style="font-size: 20px;">{{$delivery_time}}</strong>
                                        @else
                                            <span style="font-size: 20px;">وقت التوصيل :</span>
                                            <strong style="font-size: 20px;">طلب عادي</strong>
                                        @endif
                                    </div>
