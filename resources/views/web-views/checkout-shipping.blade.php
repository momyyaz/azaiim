                        ...
                        <form method="post" class="card __card" id="address-form">
                            <div class="card-body p-0">
                                ...
                                <div class="form-group mt-3 mr-3">
                                     ...
                                     <label for="delivery_type">اختر نوع الطلب</label>
                                     <select class="form-select" id="delivery_type">

                                          <option selected value="normal">طلب عادى</option>
                                          <option value="time">طلب مسبق</option>
-                                   </select>
                                 
                                    
                                </div>
                                <div class="form-group d-none delivery_time_class">
                                    <label for="delivery_time">وقت التوصيل</label>
                                    <!--{date('Y-m-d\TH:i:s')}}-->
                                    <input type="datetime-local" name="delivery_time" id="delivery_time" value="{{date('Y-m-d\TH:i:s')}}" min="{{date('Y-m-d\TH:i')}}">
                                      </div>
                            </div>
                        </form>
                    @endif
...
@push('script')
    ...
    <script>
        $('#delivery_type').on('change', function() {
            if ($(this).val() == 'time')
            {
                $('.delivery_time_class').removeClass('d-none')
            } else {
                $('.delivery_time_class').addClass('d-none')
            }
        })
        function proceed_to_next() {
            ...
            let delivery_time = $('#delivery_type').val() == 'time' ?  $('#delivery_time').val() : null;
            $.post({
