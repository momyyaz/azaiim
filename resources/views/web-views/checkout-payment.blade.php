            ...
            <section class="col-lg-8">
                ...
                <!-- Payment methods accordion-->
                    ...
                    <div class="row g-3">
                        ...
                        {{-- This is custom payment gateway (my fatoorah)--}}
                        @php($config=\App\CPU\Helpers::get_business_settings('myfatoorah'))
                        @if($config['status'])
                        <div class="col-sm-6" id="cod-for-cart">
                            <div class="card cursor-pointer">
                                <div class="card-body __h-100px">
                                    <form action="{{route('myfatoorah.payment')}}" method="get" class="needs-validation" id="myfatoorah_form">
                                        <button class="btn btn-block click-if-alone" type="submit">
                                            <img width="150" class="__mt-n-10" src="https://www.myfatoorah.com/assets/img/logo.png"/>
                                        </button>
                                    </form>
                                </div>
                            </div>
