...
@section('content')
    <div class="__inline-61">
       ...
       <a href="https://wa.me/201096983281">
		<div class="fab">
        ...
        @if (isset($flash_deals))
            <section style="direction: ltr; margin: 30px 0;" class="col-md-12 overflow-hidden">
                <div class="container">
                    <div
        ...
        @if(isset($featured_deals))
            <section class="featured_deal ltr">
                <div class="container">
                    ...
                    <div class="latest-product-margin">
                        ...
                        <div class="row mt-0 g-3">
                            @foreach($latest_products as $product)
                                <div class="col-xl-2 col-sm-4 col-md-6 col-lg-4 col-6">
                                    <div>
                            ...
                            <div>
                                @foreach($bestSellProduct as $key=>$bestSell)
                                    @if($bestSell->product && $key<3)
                                        <a class="__best-selling" style="margin-left:7px" href="{{route('product',$bestSell->product->slug)}}">
                    ...
                    <div class="card card __shadow h-100">
                        <div class="card-body p-xl-35">
                            <div class="row d-flex justify-content-between mx-1 mb-3">
                                ...
                                <div>
                                    <aclass="text-capitalize view-all-text"
                            ...
                            <div>
                                @foreach($topRated as $key=>$top)
                                    @if($top->product && $key<3)
                                        <a class="__best-selling" style="margin-left:7px" href="{{route('product',$top->product->slug)}}">
